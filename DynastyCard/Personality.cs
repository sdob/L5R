...
namespace L5R.DynastyCard
{
    class Personality : Card
    {
        ...
        public Personality()
        {
            ...
            this.baseForce = 1;
            this.baseChi = 1;
            this.honourRequirment = -1;
            this.baseGoldCost=0;
            this.basePersonalHonour=0;
            this.force=this.baseForce;
            this.chi=this.baseChi;
            this.personalHonour = this.basePersonalHonour;
